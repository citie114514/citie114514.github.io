...
同样是手机跑 Windows，APQ 背靠 QEMU，配置项是标准的 QEMU 参数写法，镜像格式用 qcow2，整体比 Bochs 那套更接近现代虚拟机的玩法；lbochs 胜在配置全是图形界面点选，门槛更低。两条路线我都写了记录，哪条顺手走哪条。再次提醒：APQ 这个方法年代较早，新安卓版本大概率跑不起来，纯属考古向折腾。
